            ...
            <div className="w-[90%] md:w-9/12 mx-auto mb-8 flex flex-col">
                ...
                {!loading && !showResult && questions.length > 0 && (
                    <div className="shadow-sm border border-gray-200 rounded p-4">
                        ...
                        <div className="mb-4">
                            <div className="flex items-center space-x-3 p-2 cursor-pointer">
                        ...
                        <div className="grid gap-4 mt-5 grid-cols-1 sm:grid-cols-2">
                            {questions[currentQuestionIndex].options.map((option, index) => (
                                <div
                                    ...
                                    className={`border p-2 rounded text-xs cursor-pointer border-gray-200 ${answers[questions[currentQuestionIndex].id] === option
                                            ? 'bg-gray-300'
                                            : ''
                                        }`}
                                >
                        ...
                        <div className="flex justify-between mt-6">
                            <button
                                ...
                                className={`px-4 py-2 rounded bg-primary text-white transition hover:bg-primary-dark ${currentQuestionIndex === 0 ? 'opacity-50 cursor-not-allowed' : ''
                                    }`}
                            >
                                Previous
                            </button>
